...
const Sportwears = () => {
  ...
  const bootsProducts = Productdata.filter(item => item.category === "sportwears");
  ...
  return (
    <div>
      ...
      <h2 className="header-text">Women Bags</h2>
          ...
          <div className="detail-content">
            <div className="detail-info">
              ...
              <div className="info">
                <h3>{detail.price}</h3>
                <p>{detail.des}</p>
                <button onClick={() => alert("Order placed successfully!")}>Order Placed</button>
