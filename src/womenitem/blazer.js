...
const Blazer = () => {
  ...
  const bootsProducts = WomenProduct.filter(item => item.category === "blazer");
  ...
  return (
    <div>
       <h1 className="header-text">Shop the Best outFit</h1> 
      <h2 className="header-text">Women's Blazer</h2>
